...
export const Setting = () => {
  ...
  return (
    <div className={`${layout_styles['setting-page-container']}`}>
      {reviewSet && (
        <>
          <header></header>
            ...
            {Object.keys(reviewSet.setting['level2days']).map((k) => {
              return (
                <div className={layout_styles['level2days-item']} key={k}>
                  <div className={layout_styles['input-number-container']}>
                    level: {k}
                    <InputNumber
                  ...
                  <div className={layout_styles['button-container']}>
                    <PlusCircleOutlined style={{ color: '#888' }} />
                    <DeleteOutlined
                      style={{ color: 'rgb(207, 18, 18)' }}
                      onClick={() => {
